...
const Color kPrimayColorDT = Color.fromARGB(255, 71, 133, 158);
const Color kPrimayLightColorDT = Color.fromARGB(255, 20, 20, 40);
...
const Color cardColorDT = Color.fromARGB(255, 56, 90, 110);
const Color scaffoldBackgroundColor = Color.fromARGB(255, 11, 41, 56);
