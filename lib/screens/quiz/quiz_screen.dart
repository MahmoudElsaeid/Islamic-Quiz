...
import 'package:islamic_quiz/firebase/loading_status.dart';
import 'package:islamic_quiz/screens/quiz/quiz_overview_screen.dart';
      ...
      child: Scaffold(
          ...
          appBar: CustomAppBar(
            ...
            titleWidget: Obx(() => Text(
                  'السؤال  ${(controller.questionIndex.value + 1).toString().padLeft(2, '0')}',
                  style: kAppBarTS,
                )),
          ),
                            ...
                            child: Obx(
                              () => Visibility(
                                ...
                                child: MainButton(
                                  ...
                                  title: controller.islastQuestion ? 'اكنمل' : 'التالي',
                                ),
                              ),
                            ),
                          )
